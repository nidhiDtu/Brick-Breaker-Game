...
public class Gameplay extends JPanel implements KeyListener, ActionListener {
    ...
    //function which receives a graphic object and draws differnt shapes like the slider, balls ,tiles etc.
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(play){
			...
			A:for(int i=0;i<generator.map.length;i++){ 			//A is the break label for outer loop from inner break
				for(int j=0;j<generator.map[i].length;j++){
